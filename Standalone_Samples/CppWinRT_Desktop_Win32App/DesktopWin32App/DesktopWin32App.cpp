...
winrt::UWPApplication::App hostApp{ nullptr };
winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource _desktopWindowXamlSource{ nullptr };
winrt::UWPApplication::MyUserControl _myUserControl{ nullptr };
                     ...
                     _In_ int       nCmdShow)
{
    ...
    hostApp = winrt::UWPApplication::App{};
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   if (_desktopWindowXamlSource != nullptr)
   {
       ...
       _myUserControl = winrt::UWPApplication::MyUserControl();
